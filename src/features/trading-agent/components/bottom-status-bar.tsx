...
export const BottomStatusBar = memo(function BottomStatusBar({ agent }: Props) {
  ...
  return (
    <footer className="sticky bottom-0 z-50 border-t border-obsidian-border bg-obsidian-light/90 backdrop-blur-xl px-4 py-2 flex items-center justify-between text-[9px] font-mono">
